...
//     var ACTIVE =                'active animate draw hovered';
//     var ACTIVE_ELEMENT_CLASS =  'active';
...
//         el = getList(el);
//         var classNamesArray = className.split('');
//
//         for(var i = 0; i<el.length; i++){
//             var item = el[i];
//             if (item.classList){
//               for(var x = 0; x < classNamesArray; x++){
//                 item.classList.add(classNamesArray[x]);
//               }
//
//             }
//             else{
//               for(var x = 0; x < classNamesArray; x++){
//               item.className += ' ' + classNamesArray[x];
//             }
//
//             }
//         }
